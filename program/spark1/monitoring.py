...
#app id
 r1 = requests.get("http://127.0.0.1:18080/api/v1/applications/").json()
...
# response time [s]
 r2=requests.get("http://127.0.0.1:18080/api/v1/applications/"+str(id)).json()
 p=r2["attempts"]
 d=p[0]
 ...
 #execution time [s]
 r3=requests.get("http://127.0.0.1:18080/api/v1/applications/"+str(id)+"/executors").json()
 t=r3[0]
 ex=t["totalDuration"]/1000
 print ("execution time: "+ str(ex)+" s")

#number of records processed
 r3=requests.get("http://127.0.0.1:18080/api/v1/applications/"+str(id)+"/stages/1").json()
 re=r3[0]
 rec=re["inputRecords"]
...
#throughput calculated as number of records processed /execution time [n/s]
 ...
 r4=requests.get("http://127.0.0.1:8474/proxies/minioProxy1/toxics/latency")
 r4=r4.json()
