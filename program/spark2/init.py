...
# this method initializes the application. It adds the minio proxy and adds the toxicity of type latency to it. Finally it starts the spark history server.
def init():
    print("Initializing")
...
def check(RT, ET, X, NL, n):
    ...
    if not (throughput_status and availability_status):
        ...
        # add available change reference copy actions to the action list
        ...
        # exploit
            ...
            # calculate the score_p associated to the actions
        ...
        # insert selected action into events table
...
def computation(n):
    ...
    # check the number of the copies of the data existing in the environment
...
def __main__():
    ...
    if json_content['initialized'] == 0:
        ...
        # infinite loop which starts the computation
        while 1:
            # arrival rate
