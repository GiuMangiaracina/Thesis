...
#app id
 r1 = requests.get("http://192.168.99.100:18081/api/v1/applications/").json()
...
# response time [s]
 r2=requests.get("http://192.168.99.100:18081/api/v1/applications/"+str(id)).json()
 p=r2["attempts"]
 d=p[0]
 ...
 #execution time [s]
 r3=requests.get("http://192.168.99.100:18081/api/v1/applications/"+str(id)+"/executors").json()
 t=r3[0]
 ex=t["totalDuration"]/1000
 print ("execution time: "+ str(ex)+" s")

#number of records processed
 r3=requests.get("http://192.168.99.100:18081/api/v1/applications/"+str(id)+"/stages/1").json()
 re=r3[0]
 rec=re["inputRecords"]
...
#throughput calculated as number of records processed /execution time [n/s]
 ...
 r4=requests.get("http://192.168.99.100:8474/proxies/minioProxy2/toxics/latency")
 r4=r4.json()
